        ...
        switch (log)
        {
           ...
           //Ad Close
            ...
            case AdmobGAEvents.InterstitialAdFailToShow:
                LogGAEvent("Admob:BAd:FailedToShow");
                break;

            case AdmobGAEvents.MrecLoaded:
                LogGAEvent("Admob:MrecAd:Loaded");
                break;
            case AdmobGAEvents.MrecDisplayed:
                LogGAEvent("Admob:MrecAd:Displayed");
                break;
            case AdmobGAEvents.MrecNotLoaded:
                LogGAEvent("Admob:MrecAd:NotLoaded");
                break;
            case AdmobGAEvents.MrecRemoved:
                LogGAEvent("Admob:MrecAd:Removed");
                break;
            case AdmobGAEvents.MrecClicked:
                LogGAEvent("Admob:MrecAd:Clicked");
                break;
