...
namespace AFPC
{
	...
	public class ControllerKeyInput : ControllerInputModule
	{
        ...
        public override void Process()
        {
            ...
            Jump = ControlFreak2.CF2Input.GetKey(jumpKey);
            Sprint = ControlFreak2.CF2Input.GetKey(sprintKey);

            Crouch = ControlFreak2.CF2Input.GetKeyDown(crouchKey);
            Prone = ControlFreak2.CF2Input.GetKeyDown(pronekey);
