...
namespace AFPC
{
	...
	public class ControllerUnityInput : ControllerInputModule
	{
        ...
        public override void Process()
        {
            ...
            Jump = ControlFreak2.CF2Input.GetButton(jumpButton);
            Sprint = ControlFreak2.CF2Input.GetButton(sprintButton);

            Crouch = ControlFreak2.CF2Input.GetButtonDown(crouchButton);
            Prone = ControlFreak2.CF2Input.GetButtonDown(proneButton);
