...
public class TBMove : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            if (ControlFreak2.CF2Input.GetKey(KeyCode.C)) anim.SetInteger("up", 3);
            if (ControlFreak2.CF2Input.anyKey) anim.SetInteger("up", 4);
        }
        ...
        if (anim.GetInteger("up") > 2)
        {
            ...
            {
                if (anim.GetFloat("walk") == 0f) active = false;
